...
| [**New Year Countdown**](./New%20Year%20Countdown) | ESP32 | **Graphics**: Sprite-based double buffering and particle systems.<br>**Networking**: NTP time synchronization. | Completed |
